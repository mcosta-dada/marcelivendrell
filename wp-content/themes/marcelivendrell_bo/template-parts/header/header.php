<div class="container-fluid p-0 position-fixed" style="z-index: 999">
			...
			<?php if ( has_nav_menu( 'header-menu' ) ) : ?>
				<nav class="navbar navbar-expand-lg <?= $post->post_name != 'home' ? 'in' : '' ?>">
					<a style="display: contents" href="/" ><img src="<?= get_stylesheet_directory_uri() ?>/img/header/logo_mini.svg" class="img-fluid logo-nav" /></a>
